...
#define LOG_FATAL(...) { NSLog::LogFunction( NSLog::FATAL_LOG, NSLog::g_Logger, __VA_ARGS__); }
#define LOG_ERROR(...) { NSLog::LogFunction( NSLog::ERROR_LOG, NSLog::g_Logger, __VA_ARGS__); }
#define LOG_WARN(...) { NSLog::LogFunction( NSLog::WARN_LOG, NSLog::g_Logger, __VA_ARGS__); }
#define LOG_INFO(...) { NSLog::LogFunction( NSLog::INFO_LOG, NSLog::g_Logger, __VA_ARGS__); }
#define LOG_DEBUG(...) { NSLog::LogFunction( NSLog::DEBUG_LOG, NSLog::g_Logger, __VA_ARGS__); }
